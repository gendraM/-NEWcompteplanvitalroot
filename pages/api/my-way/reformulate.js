    ...
    const response = await fetch('https://api.openai.com/v1/responses', {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "Ton objectif n'est pas seulement de corriger ou d'embellir le texte. Fais ressortir et structure les idées déjà exprimées afin de transformer une pensée spontanée, éventuellement brouillonne ou sous forme de liste, en une direction personnelle claire, cohérente et mémorisable.",
          "Tu peux condenser, hiérarchiser, regrouper et relier entre elles les idées déjà présentes lorsque cela clarifie leur sens, sans en créer de nouvelles et sans changer leur importance fondamentale.",
          ...
          "Le résultat doit apporter une vraie valeur de clarification : il doit être plus facile à comprendre, à relire et à retenir que le texte brut, tout en restant reconnaissable par son auteur.",
