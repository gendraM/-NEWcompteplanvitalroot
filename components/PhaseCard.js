  ...
  const guidancesCriteres = {
    1: {
      ...
      comment: [
        ...
        "• Exemple : 1 poing de riz basmati par repas",
        "",
        "🥄 1 CUILLÈRE À SOUPE = portion matières grasses",
        "• Huile d'olive, beurre, avocat",
        "• Exemple : 1 c.à.s huile d'olive pour assaisonner",
        "",
        "🍴 ÉPAISSEUR DE LA FOURCHETTE = portion protéines",
        "• Viande, poisson, œuf",
        "• Exemple : blanc de poulet épais comme 3 doigts",
        "",
        "💡 ASTUCE :",
        "Avant chaque repas, prépare ton assiette en visualisant ces repères. Prends le temps de mâcher (20 min minimum par repas)."
      ],
      suivi: "Question quotidienne : \"Aujourd'hui, j'ai utilisé les repères visuels pour mes 3 repas\" → Oui/Non (6/7 jours minimum)"
    },
    2: {
    ...
    3: {
      ...
      suivi: "Question quotidienne adaptée à ton engagement : \"Aujourd'hui, j'ai fait [marche 15 min] après chaque repas\" → Oui/Non (5/7 jours minimum)"
    },
    4: {
