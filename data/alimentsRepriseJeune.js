const alimentsRepriseJeune = [
  ...
  { 
    ...
    unite: "g",
    kcalParUnite: 0.81,
    mesureRecommandee: "Soupe décontractée",
    phase: 3,
    favoriseCetose: false,
    conseil: "Cuit Cookeo/Marmite, facile digestion"
  },
  { 
    nom: "Carotte", 
    categorie: "légume", 
    sousCategorie: "Légume vapeur", 
    kcal: 20,
    qn: 4,
    portionDefaut: "100g",
    unite: "g",
    kcalParUnite: 0.2,
    mesureRecommandee: "Bâtons cuits",
    phase: 3,
    favoriseCetose: false,
    conseil: "Vapeur Cookeo/Marmite, tendre"
  },
  { 
    nom: "Courgette", 
    categorie: "légume", 
    ...
    unite: "g",
    kcalParUnite: 0.12,
    mesureRecommandee: "Rondelles cuites",
    phase: 3,
    favoriseCetose: false,
    conseil: "Vapeur très douce, digestible"
  },
  { 
    nom: "Haricots verts", 
    categorie: "légume", 
    ...
    unite: "g",
    kcalParUnite: 0.18,
    mesureRecommandee: "Entiers cuits",
    phase: 3,
    favoriseCetose: false,
    conseil: "Vapeur tendre, bon minéraux"
  },
  { 
    nom: "Riz basmati", 
    categorie: "féculent", 
    sousCategorie: "Riz blanc", 
    kcal: 35,
    qn: 4,
    portionDefaut: "50g",
    unite: "g",
    kcalParUnite: 0.7,
    mesureRecommandee: "Portion petite",
    phase: 3,
    favoriseCetose: false,
    conseil: "Cookeo 6min / Marmite 12min, hyper-digestible"
  },
  { 
    nom: "Bouillon de poulet", 
    categorie: "bouillon", 
    sousCategorie: "Bouillon dégraissé", 
    kcal: 10,
    qn: 3,
    portionDefaut: "200ml",
    unite: "ml",
    kcalParUnite: 0.05,
    mesureRecommandee: "Bol tasse",
    phase: 3,
    favoriseCetose: false,
    conseil: "Fait maison, riche collagène minéraux"
  },
