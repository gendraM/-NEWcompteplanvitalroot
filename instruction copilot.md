RÈGLE OFFICIELLE DE FONCTIONNEMENT ET DE PASSATION (À appliquer pour tout notre travail) 🚨

À partir de maintenant, je veux que tu agisses avec la rigueur d'un développeur qui fait son compte-rendu détaillé à son manager après chaque tâche accomplie. Notre but est de garder un historique parfait pour éviter toute perte de contexte en cas de coupure.

Voici tes nouvelles directives obligatoires :
...
Date : [Insère la date du jour]

Action accomplie : [Résumé clair de ta réalisation]

Avant : [État précédent du code, le problème rencontré ou ce qui manquait]

Après : [Détail technique de ce qui a été codé, modifié ou corrigé]
